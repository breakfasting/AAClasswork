...
// askIfGreaterThan(2, 3, function(bool) {
//   console.log(bool);
// });
...
function innerBubbleSortLoop(arr, i, madeAnySwaps, outerBubbleSortLoop) {
    ...
    askIfGreaterThan(arr[i], arr[i + 1], function(arg) {
      if (!madeAnySwaps) madeAnySwaps = arg;
      if (arg) {
...
// let unsorted = [1,2,3,4,6,5,3,8];
// innerBubbleSortLoop(unsorted, 0, false, el => {
//   console.log(el);
...
// absurdBubbleSort(unsorted, function (arr) {
//     console.log("Sorted array: " + JSON.stringify(arr));
//     reader.close();
// });