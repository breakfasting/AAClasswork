...
ActiveRecord::Schema.define(version: 2020_03_20_222027) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["liked_item_id", "liked_item_type"], name: "index_likes_on_liked_item_id_and_liked_item_type"
    t.index ["user_id", "liked_item_id", "liked_item_type"], name: "index_likes_on_user_id_and_liked_item_id_and_liked_item_type", unique: true
